...
public class Withdraw_confirmationController {
    ...
    public void initialize() throws SQLException {
        ...
        cardnumber = DashboardController.cardnumber_withdraw_sender;
        Intnewamount = DashboardController.Intnewamount_withdraw;
